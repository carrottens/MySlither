...
class MySlitherJFrame extends JFrame {
...
//        settings.add(new JLabel("skin:"),
            new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
        settings.add(new JLabel("colour:"),
...
//        settings.add(snake,
    ...
    private class colorPickerQ implements ActionListener{
        public void actionPerformed(ActionEvent e) {
            if(e.getSource() == cb){
                Color a = JColorChooser.showDialog(null, "Pick your colour", Color.GREEN);
                if (a == null)
                    a = Color.GREEN;
